...
function pi() {
  if (display.innerText == 0) display.innerText = Math.PI
  else display.innerText += Math.PI
}

const plusMinus = () => (display.innerText *= -1)
...
function log2() {
  ...
  } else alert("O logarítimo de 0 não está definido!")
}
